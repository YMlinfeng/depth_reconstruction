...
def get_args_parser():
    ...
    parser.add_argument("--checkpoint_dir", type=str, default="./checkpoints", help="保存模型检查点文件夹")

    # parser.add_argument(
    #     "--data_path",
    #     # default="./data/image_generation",
    #     default="/mnt/bn/pretrain3d/real_word_data/preprocess/dcr_data",  # 修改为新的路径
    #     type=str,
